    ...
    return (
        <div className="bg-gray-100">
            <div className='max-w-6xl mx-auto py-10'>
                ...
                {
                    searchedApps.length!==0?<div className='grid grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl mx-auto my-10'>
                    {
                        searchedApps.map(app => <AppCard key={app.id} app={app}></AppCard>)
                    }
                </div>: <h1 className='h-screen flex items-center justify-center text-5xl font-bold'>No App Found</h1>
                }
            </div>
        </div>
    );
